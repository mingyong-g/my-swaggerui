 ...
 * @LastEditTime : 2020-09-25 09:24:21
 * @Description  : 
 * @FilePath     : \think-swagger-ui-vuele-master\src\views\pages\layout\commonSetting.vue
-->
<template>
  <div>
    <div style="padding:5px;">
      <tc-block title="header设置">
        <tc-button type="primary" size="small" @click="addHeader">添加</tc-button>
        <div style="margin-top:10px;">
          ...
          <el-row v-for="(item, index) in headerList" :key="item.tid" :gutter="20" style="margin-top:5px;">
            ...
            <el-col :span="3">
              <tc-button type="primary" size="small" @click="deleteRow(index)">删除</tc-button>
            </el-col>
          </el-row>
        </div>
      </tc-block>
    ...
    <tc-fixed-bottom style="text-align:center;line-height:30px;">
      <tc-button type="primary" size="small" @click="saveData">保存</tc-button>
      <tc-button type="primary" size="small" @click="$parent.hide">关闭</tc-button>
    </tc-fixed-bottom>
  </div>
</template>
