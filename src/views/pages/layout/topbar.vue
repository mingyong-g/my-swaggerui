 ...
 * @LastEditTime : 2020-09-28 11:01:45
 * @Description  : 
 * @FilePath     : \think-swagger-ui-vuele-master\src\views\pages\layout\topbar.vue
-->
<template>
  <div class="topbar-container">
    <el-menu class="topbar" mode="horizontal">
      ...
      <span class="title-font">
        <a :href="mainIndex">MY_SwaggerUI</a>
      </span>
      <div class="avatar-container">
        <tc-button size="small" type="primary" @click="openCommonSetting">通用设置</tc-button>
        <tc-button size="small" type="primary" @click="openSwaggerInfo">swagger信息</tc-button>
      </div>
    </el-menu>
    <tc-dialog loading :title="swaggerInfoDialog.title" :visible.sync="swaggerInfoDialog.show" width="600px" height="420px">
      <swagger-info />
    </tc-dialog>
